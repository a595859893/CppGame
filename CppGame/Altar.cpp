...
void Altar::randomNewHero(int index)
{
	...
	heroButton[index].writeLine("HP:   " + to_string(heros[index].getMaxHealthPoint()));
	heroButton[index].writeLine("MP:   " + to_string(heros[index].getMaxManaPoint()));
	heroButton[index].writeLine("ATK:  " + to_string(heros[index].getAttackPoint()));
	heroButton[index].writeLine("DEF:  " + to_string(heros[index].getDefencePoint()));
